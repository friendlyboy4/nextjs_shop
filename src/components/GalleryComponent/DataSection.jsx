...
export default function DataSection({ data }) {
  ...
  return (
    <DataContainer>
      <DataLine>
        <DataCell><b>Type:</b></DataCell>
        <DataCell>{type}</DataCell>
      </DataLine>
      <DataLine>
        <DataCell><b>Material:</b></DataCell>
        <DataCell>{material}</DataCell>
      </DataLine>
      <DataLine>
        <DataCell><b>Size:</b></DataCell>
        <DataCell>{size}</DataCell>
      </DataLine>
      <DataLine>
        <DataCell><b>Brake type:</b></DataCell>
        <DataCell>{brake_type}</DataCell>
      </DataLine>
      <DataLine>
        <DataCell><b>Wheel size:</b></DataCell>
        <DataCell>{wheel_size}</DataCell>
      </DataLine>
      <DataLine>
        <DataCell><b>Tyre clearance:</b></DataCell>
