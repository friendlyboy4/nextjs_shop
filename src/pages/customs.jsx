...
export default function Customs({ customs, hero }) {
  ...
  return (
    ...
    >
      ...
      <CopyBox>
        <p>
          We've got a ton of frames and unbuilt bikes ready for you to make your own!
          Pick one out, tell us how you want it built and we will do the rest.  
          Prices are subject to negotiation and will depend on the complexity of the build, 
          the labour required, and the parts cost, however a basic custom build will start from about $1000.
